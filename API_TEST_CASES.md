...
### Test Case 3.1.3: Create investment contract (paid in full)
...

{
  ...
  "startDate": "2024-12-01",
  "endDate": "2029-12-01",
  "specialTerms": "Lợi nhuận chia theo tỷ lệ 70/30",
  "contractPaymentType": "PAID_IN_FULL",
  "totalContractAmount": 2000000000,
  "depositAmount": 200000000,
  "latePaymentPenaltyRate": 0.03,
  "specialConditions": "Cam kết lợi nhuận tối thiểu 8%/năm"
}
```
...
```json
{
    ...
    "data": {
        ...
        "advancePaymentAmount": 1000000000,
        "installmentAmount": 24,
        "finalPaymentAmount": 145833333.33,
        "latePaymentPenaltyRate": 0.05,
        "startDate": "2024-12-01",
        "endDate": "2026-12-01",
        "propertyId": "uuid",
        "propertyTitle": "Căn hộ Vinhomes Grand Park",
        "customerId": "uuid",
        "customerFirstName": "Tran",
        "customerLastName": "Van B",
        "agentId": "uuid",
        "agentEmployeeCode": "AGT-001"
    }
}
